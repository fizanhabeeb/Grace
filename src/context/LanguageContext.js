...
const translations = {
  en: {
    ...
    '+addNewItem': '+ Add New Item', // Fix for button key
    editItem: 'Edit Item',
    itemName: 'Item Name',
    ...
    viewBillarrow: 'View Bill →', // Fix for casing mismatch
    ...
    '+addExpenseLabel': '+ Add Expense', // Fix for button key
    ...
    // --- Period Filters (CRITICAL FOR REPORTS/HISTORY) ---
    allTime: 'All Time',
    thisWeek: 'This Week',
    thisMonth: 'This Month',
    today: 'Today',
    week: 'Week',    // Added for History logic
    month: 'Month',  // Added for History logic
    year: 'Year',    // <--- CAPITALIZED AS REQUESTED
